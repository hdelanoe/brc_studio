  ...
  $.each(result,function(key,value){
    ...
    if( fuseOptions.tokenize ){
      ...
      $.each(value.matches,function(matchKey,mvalue){
        if(mvalue.key == "tags" || mvalue.key == "label" ){
    ...
    //replace values
    var output = render(templateDefinition,{key:key,title:value.item.title,link:value.item.permalink,tags:value.item.tags,label:value.item.label,snippet:snippet});
